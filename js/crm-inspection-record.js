/* ============================================
   驗屋紀錄頁面互動邏輯
   根據 Figma 設計稿 (node-id: 294:3663 / 294:3767)
   支援兩種狀態：已完成 (completed) / 處理中 (processing)
   ============================================ */
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  if (btnSurvey) {
    btnSurvey.addEventListener('click', function () {
      ...
      window.location.href = 'crm-satisfaction-survey.html?no=' + encodeURIComponent(caseNo) + '&type=' + encodeURIComponent('驗屋');
    });
  }
